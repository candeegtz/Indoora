...
const char* ssid = "vodafone6E70";            // Reemplaza con el nombre de tu red WiFi
const char* password = "UZMWMJMLV2MWQJ";    // Reemplaza con la contraseña de tu red WiFi

String esp32_id = "ESP32_1";  // ESTO TENGO  QUE CAMBIARLO DEPENDIENDO DE LA ESP !!!!!!!!!!!!!!!!!!


// **Configuración del broker MQTT**
const char* mqtt_server = "192.168.0.18"; // Reemplaza con la dirección de tu broker MQTT
const int mqtt_port = 1883;                             // Usualmente 1883 para MQTT sin SSL
const char* mqtt_user = "";                 // Reemplaza con tu usuario MQTT
const char* mqtt_password = "";          // Reemplaza con tu contraseña MQTT
...
const char* addresses_to_filter[numAddressesToFilter] = {
  "b06fe05ef0ac" // Reemplaza con la MAC del primer dispositivo (sin dos puntos y en minúsculas 
